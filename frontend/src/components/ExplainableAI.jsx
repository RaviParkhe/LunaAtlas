    ...
    <div className="p-5 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-[18px] shadow-sm space-y-4 transition-colors duration-200">
      ...
      <div className="flex items-center justify-between border-b border-[var(--border-color)] pb-3 flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          {isError ? (
            <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold px-2.5 py-0.5 rounded-full border bg-amber-500/10 text-amber-600 text-amber-600 border-amber-500/20">
      ...
      {isLoading ? (
        ...
        <div className="p-5 rounded-[16px] bg-amber-500/10 border border-amber-500/20 space-y-3">
          <div className="flex items-center gap-2 text-amber-700 text-amber-600 font-semibold text-xs">
            <AlertOctagon className="w-4 h-4 text-amber-600 text-amber-600" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                {siteExplanation.key_reasons && siteExplanation.key_reasons.length > 0 && (
                  <div className="p-3.5 rounded-[14px] bg-[var(--apple-parchment)] border border-[var(--border-color)] space-y-2">
                    <span className="text-[11px] font-semibold text-emerald-600 text-emerald-600 uppercase tracking-wider block">
                      Key Contributing Reasons
                    </span>
                ...
                {siteExplanation.limitations && siteExplanation.limitations.length > 0 && (
                  <div className="p-3.5 rounded-[14px] bg-[var(--apple-parchment)] border border-[var(--border-color)] space-y-2">
                    <span className="text-[11px] font-semibold text-amber-600 text-amber-600 uppercase tracking-wider block">
                    ...
                    <div className="space-y-0.5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`px-2 py-0.5 text-[10px] font-semibold rounded-full border ${
                          m.risk_level === 'HIGH'
                            ? 'bg-rose-500/10 text-rose-600 text-rose-600 border-rose-500/20'
                            : m.risk_level === 'MEDIUM'
                            ? 'bg-amber-500/10 text-amber-600 text-amber-600 border-amber-500/20'
                            : 'bg-emerald-500/10 text-emerald-600 text-emerald-600 border-emerald-500/20'
                        }`}>
                          {m.risk_level} RISK
                        </span>
                      </div>
