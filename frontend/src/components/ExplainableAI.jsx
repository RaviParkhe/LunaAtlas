...
import { Layers, Sun, Droplets, Shield, TrendingUp, Anchor, Cpu, Info } from 'lucide-react';
...
export default function ExplainableAI({ site }) {
  ...
  return (
    <div className="p-5 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-[18px] shadow-sm space-y-4 transition-colors duration-200">
      ...
      {/* Dynamic Physics Mission Briefing Banner */}
      {site?.mission_briefing && (
        <div className="p-4 rounded-[14px] bg-[var(--apple-parchment)] border border-[var(--border-color)] flex items-start gap-3">
